  ...
  <div class="nav-container page-component">
    ...
    <div class="nav left-nav">
      <div class="nav-item selected">
        <span :onclick="'javascript:window.location=\'/hospital/'+hospital.hoscode+'\''" class="v-link selected dark">预约挂号 </span>
      </div>
      <div class="nav-item ">
        <span :onclick="'javascript:window.location=\'/hospital/detail/'+hospital.hoscode+'\''" class="v-link clickable dark"> 企业详情 </span>
      </div>
      <div class="nav-item">
        <span :onclick="'javascript:window.location=\'/hospital/notice/'+hospital.hoscode+'\''" class="v-link clickable dark"> 下单须知 </span>
      </div>
    ...
    <div class="page-container">
      <div class="hospital-home">
        ...
        <div class="info-wrapper">
          <img :src="'data:image/jpeg;base64,'+hospital.logoData" :alt="hospital.hosname" class="hospital-img">
        ...
        <div class="select-dept-wrapper">
              ...
              <div class="dept-list-wrapper el-scrollbar" style="height: 100%;">
                <div class="dept-list el-scrollbar__wrap" style="margin-bottom: -17px; margin-right: -17px;">
                  <div class="el-scrollbar__view">
                    <div v-for="(item,index) in departmentVoList" :key="item.id" :class="index == activeIndex ? 'selected' : ''" class="sub-item" @click="move(index,item.depcode)"> {{ item.depname }}</div>
                  </div>
                </div>
          ...
          <div class="sub-dept-container">
            <div v-for="(item,index) in departmentVoList" :key="item.id" :class="index == 0 ? 'selected' : ''" :id="item.depcode" class="sub-dept-wrapper">
              <div class="sub-title">
                <div class="block selected"/>{{ item.depname }}
              </div>
...
import hospitalApi from '@/api/mog'
