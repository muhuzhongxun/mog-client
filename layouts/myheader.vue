<template>
  <div class="header-container">
    ...
    <!-- 登录弹出层 -->
    <el-dialog :visible.sync="dialogUserFormVisible" :append-to-body="true" style="text-align: left;" top="50px" width="960px" @close="closeDialog()">
      <div class="container">
              ...
              <el-form>
                <el-form-item>
                  <el-input v-model="dialogAtrr.inputValue" :placeholder="dialogAtrr.placeholder" :maxlength="dialogAtrr.maxlength" class="input v-input">
                    <span v-if="dialogAtrr.second > 0" slot="suffix" class="sendText v-link">{{ dialogAtrr.second }}s </span>
                    <span v-if="dialogAtrr.second == 0" slot="suffix" class="sendText v-link highlight clickable selected" @click="getCodeFun()">重新发送 </span>
                  </el-input>
                </el-form-item>
              </el-form>
